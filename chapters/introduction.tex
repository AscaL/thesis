...
\begin{figure}[H]
	\centering
	\includegraphics[width=1\textwidth]{Ppl_lie_accuracy}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.75\textwidth]{MFCC}
