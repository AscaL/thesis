...
This comparison shows interesting differences for AU04 (Brow Lowerer), AU05 (Upper Lid Raiser), AU10 (Upper Lip Raiser), AU12 (Lip Corner Puller) and AU14 (Dimpler). %"suggesting there could be a pattern"?

\subsection{Correlation}
Variables correlation is shown in figure \ref{fig:correlation_matrix}:
...
which shows some significant correlation between AUs 04, 10, 12
