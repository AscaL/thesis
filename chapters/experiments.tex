...
The results for classifying with a linear kernel are 66,34\% accuracy on the test set, which is a good starting result, while the radial kernel performed worse at around 61\% accuracy.

\clearpage

%todo: do this
\section{Results} \label{results}
Thanks to the Support Vector Machine we were able to classify deceptive and truthful videos with an accuracy of \%.
