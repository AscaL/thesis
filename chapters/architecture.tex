...
%TODO: expand saying "in the next par we will describe how we used this tool for x y z... in par x y z?
...
%todo avola: documento che parla di svm nello specifico per personalizzare / retraining di openface
...
%todo: figure with SVM with AUs divided by a line (or whatever)
